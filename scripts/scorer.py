...
def _build_gemini_prompt(jobs, settings):
    ...
    instruction_lines = [
        ...
        "Targeting junior to mid-level full-stack, backend, AI-adjacent developer roles, or QA automation engineer roles (especially Python-based).",
        "",
        "SCORING RUBRIC (use the full 0-10 range):",
        f"  9-10: Excellent — React, TypeScript, FastAPI, or Python match + junior/mid role + Israel location. QA Automation with Python also qualifies.",
        f"  7-8:  Good — 1-2 stack matches (JS, Node, Docker, PostgreSQL, REST, AI/LLM), no seniority red flags, no explicit years > {max_years}. QA Automation Engineer (any stack) = 7.",
